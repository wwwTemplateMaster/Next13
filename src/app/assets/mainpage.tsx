...
//             href="/assets/img/favicon_plain.png"
//           />
//           <link rel="icon" sizes="16x16" href="/assets/img/favicon_plain.png" />
...
//           <h1>I am Rhon</h1>
//           <h2 style={{ textAlign: "center" }}>aka: ByteBard Shad</h2>
//         </div>
//         {/* /.hero-content */}
...
//                 </li>
//                 <li>
//                   <a href="#" className="" data-group="webdesign">
//                     Web Design
//                   </a>
//                 </li>
//                 <li>
//                   <a href="#" className="" data-group="webdev">
//                     Web Development
//                   </a>
//                 </li>
//                 <li>
//                   <a href="#" className="" data-group="mobileapps">
//                     Mobile apps
//                   </a>
//                 </li>
//               </ul>
...
//                       <img src="/e_commerce1.png" alt="" className="img-res" />
//                       <a
//                         href="#"
//                         className="rectangle"
//                         data-toggle="modal"
...
//                   <div className="portfolio-item">
//                     <div className="portfolio-item-thumb">
//                       <img src="/e_commerce2.png" alt="" className="img-res" />
//                       <a
//                         href="#"
//                         className="rectangle"
//                         data-toggle="modal"
...
//                 <div
//                   className="col-lg-3 col-md-4 col-sm-6"
//                   data-groups='["mobileapps"]'
//                   style={{ marginBottom: 50 }}
//                 >
//                   <div className="portfolio-item">
//                     <div className="portfolio-item-thumb">
//                       <img src="/e_commerce3.png" alt="" className="img-res" />
//                       <a
//                         href="#"
//                         className="rectangle"
//                         data-toggle="modal"
...
//                     Like JavaScript, our approach is dynamic and responsive. We
//                     craft solutions that adapt and evolve, ensuring your
...
//                     prioritize clear and organized communication to ensure every
//                     aspect of your project is structured for success.
//                   </p>
//                 </div>
//                 {/* /.main-service */}
//               </div>
...
//               width={52}
//               height={52}
//               style={{ margin: "0 15px", animation: "fadeIn 1s ease-out 0.2s" }}
//             />
//             <img
//               src="/nextjs.png"
//               alt=""
//               width={32}
//               height={32}
//               style={{ margin: "0 15px", animation: "fadeIn 1s ease-out 0.4s" }}
//             />
//             <img
//               src="/tailwind.png"
//               alt=""
//               width={32}
//               height={32}
//               style={{ margin: "0 15px", animation: "fadeIn 1s ease-out 0.6s" }}
//             />
//             <img
//               src="/mysql.png"
//               alt=""
//               width={52}
//               height={52}
//               style={{ margin: "0 15px", animation: "fadeIn 1s ease-out 0.8s" }}
//             />
//           </div>
//         </section>
//         {/* /.section-hello */}
...
//                         </h3>
//                         <p>
//                           We believe content is king. Flashy visuals are great,
//                           but they shouldn't overshadow the message. We design
//                           around your actual content, not dummy text, to ensure
//                           your website is both beautiful and functional. This
//                           avoids cluttered layouts and ensures your site works
//                           perfectly once real data is in place. Our
//                           content-first approach keeps users engaged and
//                           informed, leading to a better experience for everyone.
//                         </p>
//                       </div>
//                     </div>
...
//                         <p>
//                           A stunning design is just the beginning. We take your
//                           vision and make it a reality with robust back-end
//                           development. We build the hidden engine that powers
//                           your website, ensuring seamless functionality and a
//                           flawless user experience. From databases to servers,
//                           we handle the complex infrastructure so you can focus
//                           on what matters most – your business. With our
//                           back-end expertise, your website won't just look
//                           great, it will run flawlessly.
//                         </p>
//                       </div>
//                     </div>
//                     <div className="col-md-7">
...
//                         </h3>
//                         <p>
//                           Mobile App Development: Reach Your Audience Anywhere,
//                           Anytime. In today's mobile-driven world, a strong app
//                           is essential. We create exceptional mobile experiences
//                           that connect you with your audience on their favorite
//                           devices. Our team crafts intuitive, feature-rich apps
//                           that are visually stunning and a joy to use. Expand
//                           your reach, boost engagement, and take your business
//                           to the next level with a powerful mobile app.
//                         </p>
//                       </div>
//                     </div>
//                     <div className="col-md-7">
...
//                           maintenance and optimization, allowing you to focus on
//                           leveraging your data for growth and success. With our
//                           reliable database solutions, you can trust that your
//                           valuable information is always in good hands.
//                         </p>
//                       </div>
//                     </div>
//                     <div className="col-md-7">
...
//                         </h3>
//                         <p>
//                           Keep your projects on track and your team in sync. We
//                           utilize industry-leading version control systems like
//                           Git to manage code changes, facilitate collaboration,
//                           and ensure project history is always accessible. Our
//                           streamlined deployment processes get your updates and
//                           new features live quickly and efficiently. With our
//                           version control and deployment expertise, you can
//                           focus on building great things, not managing the
//                           technical details.
//                         </p>
//                       </div>
//                     </div>
...
//       {/* /.modal-dialog */}
//       {/* /.modal */}
//       <div id="portfolioItem2" className="modal fade fade-scale" role="dialog">
//         <div className="modal-dialog modal-lg">
//           <div className="modal-content">
//             <div className="modal-header d-flex justify-content-end">
//               {/* Align items to the end */}
...
//       </div>
//       {/* /.modal */}
//       <div id="portfolioItem3" className="modal fade fade-scale" role="dialog">
//         <div className="modal-dialog modal-lg">
//           <div className="modal-content">
//             <div className="modal-header d-flex justify-content-end">
//               {/* Align items to the end */}
...
//       </div>
//       {/* /.modal */}
//       <div id="portfolioItem4" className="modal fade fade-scale" role="dialog">
//         <div className="modal-dialog modal-lg">
//           <div className="modal-content">
//             <div className="modal-header d-flex justify-content-end">
//               {/* Align items to the end */}
...
//       </div>
//       {/* /.modal */}
//       <div id="portfolioItem5" className="modal fade fade-scale" role="dialog">
//         <div className="modal-dialog modal-lg">
//           <div className="modal-content">
//             <div className="modal-header d-flex justify-content-end">
//               <a className="rectangle" data-dismiss="modal">
...
//       </div>
//       {/* /.modal */}
//       <div id="portfolioItem6" className="modal fade fade-scale" role="dialog">
//         <div className="modal-dialog modal-lg">
//           <div className="modal-content">
//             <div className="modal-header d-flex justify-content-end">
//               <a className="rectangle" data-dismiss="modal">
...
//       </div>
//       {/* /.modal */}
//       <div id="portfolioItem7" className="modal fade fade-scale" role="dialog">
//         <div className="modal-dialog modal-lg">
//           <div className="modal-content">
//             <div className="modal-header d-flex justify-content-end">
//               <a className="rectangle" data-dismiss="modal">
...
//       </div>
//       {/* /.modal */}
//       <div id="portfolioItem8" className="modal fade fade-scale" role="dialog">
//         <div className="modal-dialog modal-lg">
//           <div className="modal-content">
//             <div className="modal-header d-flex justify-content-end">
//               <a className="rectangle" data-dismiss="modal">
